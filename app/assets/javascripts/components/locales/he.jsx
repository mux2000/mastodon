const he = {
  ...
  "account.unblock": "הסרת חסימה מ-@{name}",
  "account.unfollow": "הפסקת עקיבה",
  "account.unmute": "הפסקת השתקת @{name}",
  "boost_modal.combo": "ניתם להקיש {combo} כדי לדלג בפעם הבאה",
  ...
  "empty_column.home": "אף אחד לא במעקב עדיין. אפשר לבקר ב{public} או להשתמש בחיפוש כדי להתחיל ולהכיר חצרורנים אחרים.",
  ...
  "home.column_settings.filter_regex": "סינון באמצעות ביטויים רגילים לחלוטין (regular expressions)",
  "home.column_settings.show_reblogs": "הצגת הדהודים",
  "home.column_settings.show_replies": "התגת תגובות",
