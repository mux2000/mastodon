const he = {
  ...
  "empty_column.community": "טור הסביבה ריק. פרסמו משהו כדי שדברים יתרחילו להתגלגל!",
  ...
  "notification.favourite": "חותך חובב על ידי {name}",
  "notification.follow": "{name} בעקיבה אחרייך",
  "notification.mention": "קיבלת פניה מאת {name}",
  "notification.reblog": "חותך הודהד על ידי {name}",
  ...
  "privacy.unlisted.long": "לא להצגה בפרומבי",
